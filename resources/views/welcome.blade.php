...
<head>
    ...
    <link rel="stylesheet" href="https://jokul.doku.com/jokul-checkout-js/v1/jokul-checkout-1.0.0.css">
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <div id="docs-card"
                            ...
                            <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                <form class="needs-validation ng-untouched ng-pristine ng-valid">
                                    <div class="mb-3"><label>Name</label><input type="text" id="customer_name"
                                            placeholder="Anton Budiman" value="Anton Budiman" required=""
                                            class="form-control dk-text-input">
                                        <div class="invalid-feedback"> Valid name is required.
                                        </div>
                                    </div>
                                    <div class="mb-3"><label>Email</label><input type="email" id="customer_email"
                                            placeholder="you@example.com" value="anton@budiman.com" required=""
                                            class="form-control dk-text-input">
                                        <div class="invalid-feedback"> Please enter a valid email
                                            address for shipping updates. </div>
                                    </div>
                                    <div class="mb-3"><label>Phone
                                            Number</label><input type="email" id="customer_phone"
                                            placeholder="6281111111111" value="6281111111111" required=""
                                            class="form-control dk-text-input">
                                        <div class="invalid-feedback"> Please enter a valid phone
                                            number for shipping updates. </div>
                                    </div>
                                    <div class="mb-3"><label>Address</label><input type="text"
                                            id="customer_address" placeholder="Menara Mulia Lantai 8"
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 mb-3"><label for="country">Country</label><select
                                                id="country" required="" class="form-control">
                                                <option value="Indonesia">Indonesia</option>
                                            </select>
                                            <div class="invalid-feedback"> Please select a valid
                                                country. </div>
                                        </div>
                                        <div class="col-md-4 mb-3"><label>City</label><select id="province"
                                        ...
                                        <div class="col-md-3 mb-3"><label>Postal Code</label><input type="text"
                                                id="postalcode" placeholder="" value="12930" required=""
                                                class="form-control dk-text-input">
                                            <div class="invalid-feedback"> Postal code required.
                                            </div>
                                        </div>
                                    </div>
                                    <input type="text" id="order_amount" placeholder="120000" value="120000"
                                        class="form-control dk-text-input">


                                    <a onclick="payment()" class="btn btn-primary btn-lg btn-block mb-3"
                                        style="color: #ffffff;">Purchase</a><span id="doku"></span>
                                </form>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <form novalidate=""
                                            ...
                                            <div class="mb-3"><label _ngcontent-tbi-c77="">Client ID</label><input
                                                    type="text" id="clientId" placeholder="MCH-xxxxxx"
                                                    value="BRN-0236-1655873540433" required=""
                                                    class="form-control dk-text-input">
                                                <div class="invalid-feedback"> Client ID is
                                                    required. </div>
                                            </div>
                                            <div class="mb-3"><label _ngcontent-tbi-c77="">Shared Key</label><input
                                                    id="sharedKey" placeholder="SK-xxxxxx"
                                                    value="SK-7bdly2ITZiWR54JzWNxM" required=""
                                                    class="form-control dk-text-input">
                                                <div class="invalid-feedback"> Shared Key is
                                                    required. </div>
                                            </div>
                                            <div class="mb-3"><label _ngcontent-tbi-c77="">Merchant
                                                    Name</label><input type="text" id="merchanName"
                                                    placeholder="Toko Susu" value="Toko Susu" required=""
                                                    class="form-control dk-text-input">
                                                <div class="invalid-feedback"> Merchant Name is
                                                    required. </div>
                                            </div>
                                            <div class="mb-3"><label _ngcontent-tbi-c77=""
                                                    for="country">Environment</label><select _ngcontent-tbi-c77=""
                                                    id="environment" required="" class="form-control">
                                                    <option value="sandbox">Sandbox</option>
                                                </select>
                                                <div class="invalid-feedback"> Environment is
                                                    required. </div>
                                            </div>
                                            <hr class="my-3">
                                            <h4 class="mb-3">Payment Settings</h4>
                                            <div class="mb-3"><label _ngcontent-tbi-c77="">Callback
                                                    URL</label><input type="text" id="order_callback_url"
                                                    placeholder="https://merchantwebsite.com" value="https://doku.com"
                                                    required="" class="form-control dk-text-input">
                                                <div class="invalid-feedback"> Merchant Name is
                                                    required. </div>
                                            </div>
                                            <div class="mb-3"><label _ngcontent-tbi-c77="">DOKU Wallet Notify
                                                    URL</label><input type="url" id="doku_wallet_notify_url"
                                                    placeholder="https://merchantwebsite.com" value="https://doku.com"
                                                    class="form-control dk-text-input"></div>
                                            <div class="mb-3"><label _ngcontent-tbi-c77="">Customer ID</label><input
                                                    type="text" id="customer_id" placeholder="Customer ID"
                                                    class="form-control dk-text-input">
                                            </div><a href="#" data-dismiss="modal"
                                                class="btn btn-primary btn-lg btn-block">Save Configuration</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
